			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9 col-12 col-md-9 col-xl-10 pl-1 pr-1 ml-auto mr-auto">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<a href="{{route('productApp.show',$pro->id)}}">
								<div class="col-md-3 col-6 col-lg-3 col-xl-3 mt-2">
									<div class="men-pro-item simpleCart_shelfItem ml-xl-3 mr-xl-3 p-2 pro-detail">
										<div class="men-thumb-item text-center" >
											<div class=" mr-auto ml-auto " >
												<img class="img-fluid img-thumbnail" src="/upload/thumbnail/{{$pro->thumbnail}}" width="90%" style="min-width: 100%;height: 200px;" alt="">	
											</div>											
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Category</h3>
							@foreach ($category_pro as $cate_pro)
							<h5  style="color: navy;font-style: oblique;"><a href="{{route('categoryList.show',$cate_pro->id)}}">{{$cate_pro->name}}</a></h5>
							<hr wibth="100%" style="background-color: tomato;">
							<div class="row mt-2" >
							@foreach ($cate_pro->product as $key=>$value)
							@if($key <= 4)
								<div class="col-md-3 col-6 col-lg-3 col-xl-3 mt-2" >
									<a href="{{route('productApp.show',$value->id)}}">
									<div class="men-pro-item simpleCart_shelfItem ml-xl-3 mr-xl-3 p-2 pro-detail">
										<div class="men-thumb-item text-center">
											<div class="mr-auto ml-auto">
												<img src="/upload/thumbnail/{{$value->thumbnail}}"  class="img-thumbnail" width="100%" style="height: 200px;" alt="">	
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Viewed products</h3>
							<hr wibth="100%" style="background-color: tomato;">
							<div class="row mt-2" >
							@foreach($view as $key=>$view)
							<a href="{{route('productApp.show',$view->product->id)}}">
								<div class="col-md-3 col-6 col-lg-3 col-xl-3 mt-2 ">
									<div class="men-pro-item simpleCart_shelfItem ml-xl-3 mr-xl-3 p-2 pro-detail">
										<div class="men-thumb-item text-center">
											<div class="mr-auto ml-auto">
												<img src="/upload/thumbnail/{{$view->product->thumbnail}}" class="img-thumbnail" width="100%" style="height: 200px;"alt="">
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="{{route('productApp.show',$view->product->id)}}">{{$view->product->name}}</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">{{number_format($view->product->price,3)}} VNĐ</span>
												<del>$300.00</del>
											</div>
										</div>
									</div>
