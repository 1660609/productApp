...
<div class="ads-grid py-sm-5 py-4">
	<div class=" py-xl-4 py-lg-2">
		...
		<div class="row">
				...
				<div class="container-fluid" >
					<nav class="navbar navbar-light pl-0 pr-0">
						...
						<ul class="nav navbar-nav pl-0 pr-0">
							...
							<div class="ml-auto mr-auto mt-2 ml-0 mr-0 pl-0 pr-0 w-100" >
								<h6>Address</h6>
								<select class="custom-select custom-select-sm w-100 mt-2" name="srcAddress" value="{{$srcAddress ?? ''}}" >
			...
			<div class="agileinfo-ads-display col-lg-9 col-12 col-md-9 col-xl-10 pl-0 pr-0 ml-auto mr-auto">
				<div class="wrapper">
					<!-- first section -->
					<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
						<h3 class="heading-tittle text-left font-italic">{{$category->name}}</h3>
								...
								<div class="men-pro-item simpleCart_shelfItem ml-xl-3 mr-xl-3 p-2 pro-detail">
									<div class="men-thumb-item text-center">
										<div class="mr-auto ml-auto ">
											<img src="/upload/thumbnail/{{$pro->thumbnail}}" class="img-fluid img-thumbnail" width="100%" style="min-height: 200px;" alt="">
										</div>
									</div>
